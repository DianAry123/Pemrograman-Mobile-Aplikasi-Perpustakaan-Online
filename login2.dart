  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(
          ...
          title: new Center(
            child: new Text("Welcome Readers!"),
          ),
          actions: <Widget>[
            IconButton(
          ...
          Card(
              ...
              child: Container(
                  ...
                  child: InkWell(
                    ...
                    child: ProductBox(
                      name: "Sepotong Hati yang Baru - Tere Liye",
                      description:
...
class ProductBox extends StatelessWidget {
  ProductBox({Key key, this.name, this.image, this.description})
      : super(key: key);
